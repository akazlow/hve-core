...
This prompt processes **documentation files only**. Prompt engineering artifacts (.github/instructions/, prompts/, agents/, skills/) are out of scope. Use the prompt-build skill for those file types.
