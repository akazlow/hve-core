...
Use [references/refactor-loop.md](references/refactor-loop.md) for the operational contract and [references/refactor-checklist.md](references/refactor-checklist.md) for cleanup heuristics and Prompt Quality Criteria alignment guidance.
